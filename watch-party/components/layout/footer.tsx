    ...
    <footer className="bg-secondary border-t border-border">
      <div className="container px-4 py-12 sm:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-muted-foreground">
              The ultimate platform for watching football games together with friends, no matter where you are.
            </p>
        ...
        <div className="mt-12 border-t border-border pt-8">
          <p className="text-xs leading-5 text-muted-foreground">&copy; 2024 Watch Party. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
