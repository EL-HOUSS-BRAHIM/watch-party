...
const mockVideos: VideoContent[] = [
  {
    id: '1',
    title: 'Amazing Movie Review: The Latest Blockbuster',
    description: 'An in-depth review of the latest blockbuster movie with detailed analysis...',
    ...
    moderationFlags: [
      {
        ...
        reason: 'Contains copyrighted movie clips without permission',
        severity: 'high',
      },
      {
        id: '2',
        ...
        reason: 'Promoting external paid content',
        severity: 'medium',
      },
    ],
    aiAnalysis: {
      contentScore: 7.2,
      categories: ['Entertainment', 'Review', 'Movies'],
      confidence: 0.89,
      suggestedAction: 'review',
      detectedObjects: ['person', 'screen', 'text'],
      audioAnalysis: {
        language: 'English',
        profanityScore: 0.1,
        sentiment: 0.7,
  ...
  },
  {
    ...
    description: 'My top 5 movie recommendations for this week',
    thumbnail: '/placeholder.jpg',
    duration: 634, // 10:34
    uploadDate: '2024-01-14T16:45:00Z',
    uploader: {
      id: 'user2',
      username: 'weeklyreviews',
      displayName: 'Sarah Weekly',
      avatar: '/placeholder-user.jpg',
    },
    status: 'pending',
    moderationFlags: [],
    aiAnalysis: {
      contentScore: 9.1,
      categories: ['Entertainment', 'Recommendations'],
      confidence: 0.95,
      suggestedAction: 'approve',
      detectedObjects: ['person', 'books', 'poster'],
      audioAnalysis: {
        language: 'English',
        profanityScore: 0.0,
        sentiment: 0.85,
  ...
  },
  {
    ...
    description: 'This video contains inappropriate content for testing moderation',
    thumbnail: '/placeholder.jpg',
    duration: 156,
    uploadDate: '2024-01-13T20:15:00Z',
    uploader: {
      id: 'user3',
      username: 'testuser',
    ...
    moderationFlags: [
      {
        ...
        type: 'inappropriate',
        reporter: 'auto_ai',
        timestamp: '2024-01-13T20:16:00Z',
    ...
    aiAnalysis: {
      ...
      detectedObjects: ['adult_content'],
    },
    views: 23,
    likes: 0,
    comments: 1,
    reports: 12,
    lastModerated: '2024-01-13T20:30:00Z',
    moderatedBy: 'admin1',
    moderationNotes: 'Content violates community guidelines - adult content',
  },
];
