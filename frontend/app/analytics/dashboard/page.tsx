...
export default function AdminAnalyticsDashboard() {
      ...
      const mockMetrics: AdminMetrics = {
        ...
        trends: {
          userGrowth: Array.from({ length: 30 }, (_, i) => ({
            ...
            users: 15000 + Math.floor(Math.random() * 500) + i * 10,
            active: 8500 + Math.floor(Math.random() * 300) + i * 8,
          })),
          revenueGrowth: Array.from({ length: 30 }, (_, i) => ({
            date: new Date(Date.now() - (29 - i) * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
            revenue: 120000 + Math.floor(Math.random() * 5000) + i * 100,
            subscriptions: 1200 + Math.floor(Math.random() * 50) + i * 2,
          })),
          contentMetrics: Array.from({ length: 30 }, (_, i) => ({
            date: new Date(Date.now() - (29 - i) * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
            videos: 2800 + i * 2,
            watchTime: 45000 + Math.floor(Math.random() * 5000),
          })),
          partyMetrics: Array.from({ length: 30 }, (_, i) => ({
            date: new Date(Date.now() - (29 - i) * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
            parties: 1500 + i * 3,
            participants: 8500 + Math.floor(Math.random() * 500),
          })),
        },
        demographics: {
          ageGroups: [
            { range: '18-24', count: 3200, percentage: 20.8 },
            { range: '25-34', count: 5100, percentage: 33.1 },
            { range: '35-44', count: 4200, percentage: 27.2 },
            { range: '45-54', count: 2100, percentage: 13.6 },
            { range: '55+', count: 820, percentage: 5.3 },
          ],
          locations: [
            { country: 'United States', count: 6200, percentage: 40.2 },
            { country: 'Canada', count: 2100, percentage: 13.6 },
            { country: 'United Kingdom', count: 1800, percentage: 11.7 },
            { country: 'Germany', count: 1200, percentage: 7.8 },
            { country: 'France', count: 980, percentage: 6.4 },
            { country: 'Others', count: 3140, percentage: 20.3 },
          ],
          devices: [
            { type: 'Desktop', count: 8500, percentage: 55.1 },
            { type: 'Mobile', count: 5200, percentage: 33.7 },
            { type: 'Tablet', count: 1720, percentage: 11.2 },
          ],
          subscriptionTiers: [
            { tier: 'Free', count: 10200, revenue: 0, color: '#94a3b8' },
            { tier: 'Basic', count: 3800, revenue: 38000, color: '#3b82f6' },
            { tier: 'Premium', count: 1200, revenue: 60000, color: '#8b5cf6' },
            { tier: 'Pro', count: 220, revenue: 27000, color: '#f59e0b' },
          ],
        },
        performance: {
          serverMetrics: Array.from({ length: 24 }, (_, i) => ({
          ...
          errorRates: Array.from({ length: 7 }, (_, i) => ({
            ...
            total: 10000 + Math.floor(Math.random() * 2000),
          })),
          loadTimes: [
            { page: 'Home', averageTime: 1.2, p95Time: 2.8 },
            { page: 'Dashboard', averageTime: 1.8, p95Time: 3.5 },
            { page: 'Video Player', averageTime: 2.1, p95Time: 4.2 },
            { page: 'Profile', averageTime: 1.5, p95Time: 3.1 },
            { page: 'Search', averageTime: 2.3, p95Time: 4.8 },
          ],
        },
        retention: {
          cohorts: [
            { cohort: 'Jan 2024', week0: 100, week1: 85, week2: 72, week4: 58, week8: 45 },
            { cohort: 'Feb 2024', week0: 100, week1: 88, week2: 75, week4: 62, week8: 48 },
            { cohort: 'Mar 2024', week0: 100, week1: 82, week2: 69, week4: 55, week8: 42 },
            { cohort: 'Apr 2024', week0: 100, week1: 90, week2: 78, week4: 65, week8: 52 },
          ],
          engagement: Array.from({ length: 30 }, (_, i) => ({
            date: new Date(Date.now() - (29 - i) * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
            dau: 8000 + Math.floor(Math.random() * 1000),
            wau: 12000 + Math.floor(Math.random() * 1500),
            mau: 15000 + Math.floor(Math.random() * 500),
          })),
        },
      };
  ...
  const exportData = () => {
    ...
    a.href = url;
    a.download = `admin-analytics-${timeframe}-${new Date().toISOString().split('T')[0]}.json`;
