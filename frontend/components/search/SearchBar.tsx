    ...
    <div className={`relative ${className}`}>
      <div className="relative">
        ...
        <input
          ...
          autoFocus={autoFocus}
          className={`w-full pl-10 pr-4 bg-white/10 border border-brand-navy/20 rounded-lg text-brand-navy placeholder-brand-navy/50 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:border-transparent transition-all ${getSizeClasses()}`}
        />
        ...
        <div className="absolute top-full left-0 right-0 mt-1 bg-gray-800 border border-white/20 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto">
          {suggestions.map((suggestion, index) => (
            <button
              ...
              className="w-full px-4 py-2 text-left text-brand-navy hover:bg-white/10 first:rounded-t-lg last:rounded-b-lg transition-colors"
            >
      ...
      {showFilters && (
        <div className="mt-2 flex gap-2">
          <select
            ...
            className="px-2 py-1 bg-white/10 border border-brand-navy/20 rounded text-brand-navy text-sm focus:outline-none focus:ring-1 focus:ring-brand-blue"
          >
