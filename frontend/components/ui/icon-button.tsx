...
export function IconButton({ 
  ...
  const variants = {
    primary: gradient 
      ...
      : "bg-gradient-to-r from-brand-purple to-brand-blue hover:from-brand-purple-dark hover:to-brand-blue-dark text-white shadow-lg hover:shadow-purple-500/25",
