...
const testTrends = Array.from({ length: 30 }, (_, i) => ({
...
const coverageData = [
  { name: "Statements", value: 92, color: "#6366f1" },
  { name: "Branches", value: 88, color: "#8b5cf6" },
  { name: "Functions", value: 95, color: "#06b6d4" },
  { name: "Lines", value: 90, color: "#10b981" },
]
