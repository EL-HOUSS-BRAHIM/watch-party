    ...
    try {
      ...
      if (systemHealth) {
        setSystemHealth({
          ...
          network: 12, // Network metrics not available in current API
          status: systemHealth.overall_status === 'healthy' ? "healthy" : systemHealth.overall_status === 'warning' ? "warning" : "critical",
        })
      }
